...
#define MCX_SRC_DONUT		15 //A donut like shape for simulating jm-103
#define MCX_SRC_PATTERN3D	16 //Isotropic laucnhing point weighed with excitation matrix
#define MCX_SRC_WEIGHED		17 //sampled launch function based on weights of in a 3d pattern
#define MCX_SRC_WEIGHED3D   18 //launches photon based on a srcpattern 
#define MCX_SRC_FIBER		19 // simulates a optical fiber with width and NA
#define MCX_SRC_FIBERGAUSS  20 // mixture of fiber and gaussian 
#define MCX_SRC_CYLLENS		21 // what happens after we apply a cyl lens so its a mix of slit and divergence
#endif
